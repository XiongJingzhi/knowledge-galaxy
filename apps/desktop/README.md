...
- 文档工作台新增“文档信号条”，可从最常见的类型、状态、主题统计直接切入聚焦视图
- 文档编辑区新增“文档档案”条，集中展示类型、slug、创建/更新时间、关系标签，并支持复制当前文档路径
- 创建、保存、导入、校验、导出与项目命令完成后，会进入“最近操作”反馈层
- 各主工作台上方都有 section hero，用来解释当前区域职责，并提供快捷动作，例如新建 Note、重置文档视图、快速校验
...
- 新增交互时优先补入对应工作台的 section hero，而不是把所有动作继续堆进列表或表单区
